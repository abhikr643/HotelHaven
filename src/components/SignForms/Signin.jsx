      ...
      <div class="card card0">
          <div class="d-flex flex-lg-row flex-column-reverse">
                  ...
                  <div class="row justify-content-center my-auto">
                      <div class="col-md-8 col-10 my-5">
                          <div class="row justify-content-center px-3 mb-3">
                              <img id="logo" src="/Images/hotel-logo.png"/>
                          </div>
                          <h3 class="mb-5 text-center heading">HotelHaven</h3>
  
                          <h6 class="msg-info">Please login to your account</h6>
  
                          <div class="form-group">
                              <label class="form-control-label text-muted">Username</label>
                              <input type="text" id="email" name="email" placeholder="Phone or email id" class="form-control"/>
                          </div>
                          ...
                          <div class="row justify-content-center my-3 px-3">
                              <button class="btn-block btn-color">Login to HotelHaven</button>
                          </div>
              ...
              <div class="card card2">
                  ...
                  <div class="row justify-content-center my-3 px-3">
                        <Link to={"/"}><button class="btn-block btn-color" onClick={handledashboard}>Dashboard</button></Link>
                          </div>
                      <h3 class="text-white">Hey! There</h3>
